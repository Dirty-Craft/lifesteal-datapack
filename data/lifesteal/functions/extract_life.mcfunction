...
execute if score @s ls_maxHealth matches 7.. run give @s warped_fungus_on_a_stick{display:{Name:'{"text":"Heart","color":"red","bold":true}',Lore:['{"text":"Life is short or is it?","color":"dark_purple","italic":true}']},CustomModelData:69421,Enchantments:[{}]} 1
